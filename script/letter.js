function runHeart(){
    ...
    <div class="box">
        <img class="img" src="resources/heart.png">
        // <canvas id="pinkboard"></canvas>
    </div>
    <div class="sp-container">
        <div class="sp-content">
            <div class="sp-globe"></div>
            <h2 class="frame-1">Nhân ngày Nhà giáo Việt Nam</h2>
            <h2 class="frame-2">20/11</h2>
            <h2 class="frame-3">kính chúc cô có thật nhiều</h2>
            <h2 class="frame-4">niềm vui, sức khoẻ</h2>
    ...
    e.setAttribute('src', "./script/heart.js")
